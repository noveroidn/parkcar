    ...
    return ContainerWidget(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: AppPallete.colorPrimary.withOpacity(.4),
              blurRadius: 24,
        ...
        child: Row(
          children: [
            ...
            Column(
              ...
              children:
              [Text('Angga Tower', style: GoogleFonts.plusJakartaSans(
                  fontSize: 16,
                  fontWeight: FontWeight.w800,
                  color: AppPallete.white
              ),
              ),
                Text('Lot 193MB', style: GoogleFonts.plusJakartaSans(
                    fontSize: 14,
